...
$(document).ready(function () {
    ...
    product_slides.on('change.owl.carousel', function (event) {
        var $currentItem = $('.owl-item', product_slides).eq(event.item.index);
        var $elemsToanim = $currentItem.find("[data-out]");
        setAnimation($elemsToanim, 'out');
    });
    ...
    product_slides.on('changed.owl.carousel', function (event) {
